...
using System.IO;
using sbsp = TagTool.Definitions.scenario_structure_bsp;

namespace TagTool.Definitions.ReachRetail
{
    public class scenario_structure_bsp : ReachBeta.scenario_structure_bsp
    {
        ...
        public scenario_structure_bsp(CacheBase Cache, int Address)
        {
            ...
            var er = new EndianReader(new MemoryStream(Cache.zone.FixupData), EndianFormat.Big);
