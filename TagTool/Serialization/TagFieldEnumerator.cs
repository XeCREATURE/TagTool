...
namespace TagTool.Serialization
{
    ...
    public class TagFieldEnumerator
    {
        ...
        /// <summary>
        /// Gets the lowest engine version which supports this property, or <see cref="DefinitionSet.Unknown"/> if unbounded.
        /// </summary>
        public DefinitionSet MinVersion { get; private set; }

        /// <summary>
        /// Gets the highest engine version which supports this property, or <see cref="DefinitionSet.Unknown"/> if unbounded.
        /// </summary>
        public DefinitionSet MaxVersion { get; private set; }
