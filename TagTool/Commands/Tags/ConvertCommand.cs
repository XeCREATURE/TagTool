...
namespace TagTool.Commands.Tags
{
    class ConvertCommand : Command
    {
        ...
        private ResourceLocation FixResourceLocation(ResourceLocation location, DefinitionSet srcVersion, DefinitionSet destVersion)
        {
        ...
        private void FixObjectTypes(object data, Type type, OpenTagCache srcInfo)
        {
            ...
            {
                if (Definition.Compare(srcInfo.Version, DefinitionSet.HaloOnline498295) < 0)
                {
