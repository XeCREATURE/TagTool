...
{
    [TagStructure(Name = "sound", Class = "snd!", Size = 0xD4, MaxVersion = DefinitionSet.HaloOnline235640)]
    [TagStructure(Name = "sound", Class = "snd!", Size = 0xD8, MinVersion = DefinitionSet.HaloOnline301003, MaxVersion = DefinitionSet.HaloOnline449175)]
    [TagStructure(Name = "sound", Class = "snd!", Size = 0xD4, MinVersion = DefinitionSet.HaloOnline498295)]
    public class Sound
    {
        public uint Flags;
        public uint Unknown;
