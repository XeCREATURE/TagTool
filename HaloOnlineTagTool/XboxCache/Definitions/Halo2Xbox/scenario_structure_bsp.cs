...
using sbsp = HaloOnlineTagTool.XboxCache.Definitions.scenario_structure_bsp;
using mode = HaloOnlineTagTool.XboxCache.Definitions.render_model;

namespace HaloOnlineTagTool.XboxCache.Definitions.Halo2Xbox
{
